...
<p>   
 ...
 <div  id="left_right_mod" class="swiper-slide <?php if ($first_mod == "1" ) {echo "swiper-slide-active";}elseif($first_mod == "2"){echo " lastslide";}?>  left_right" > 
                  ...
                  <?php if($my_images){ ?>
                   ...
                   <div class="right_text <?php echo $my_text_colors.$my_text_alphass; ?>"<?php if ($left_right == "1" ) {echo "id='left_posib'";}else{echo "id='right_posib'";}; echo $mytext_xy;?> >
                        <div  id="alpha">
             ...
             <a  href="<?php echo  $my_url; ?>" target="_blank"class="index_mod_bag " style=" background-image:url(<?php if($my_b_images){echo $my_b_images ;}?>)">
