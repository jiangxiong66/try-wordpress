...
$customize_title = sprintf( __( 'Customize &#8220;%s&#8221;' ), $ct->display('Name') );
 ?>
        <p><b>主题名称：<?php echo $ct->display('Name'); ?></b> <a class="banben">版本：<?php echo $ct->display('Version'); ?></a>
         <a  href=" http://www.themepark.com.cn/tygzwordpressqyzt.html" target="_blank" class="jieshao">详细介绍</a> 
        <a href="http://www.themepark.com.cn/?s=%E9%80%9A%E7%94%A8%E6%BB%9A%E8%BD%B4&cat=7,8,56" target="_blank" class="bangzhu">视频教程</a></p>
        <p><b>主题出品：</b><a target="_blank" href="http://www.themepark.com.cn"><?php echo $ct->display('Author'); ?></a>  <a href="http://www.themepark.com.cn/tygzwordpressqyzt.html" target="_blank">正版用户可以享受后台一键自动更新（仪表盘-->更新检查）</a></p>
