 ...
 <div class="contact_footer_box "></div>
      <div class="contact_footer <?php if(get_option('mytheme_footer_open')=='value2'){echo 'display_none';} ?>">
           ...
           <?php  if(get_option('mytheme_QQ')){?>   <a class="contact_footer_qq" target="_blank" href="<?php echo get_option('mytheme_QQ'); ?>"><?php echo $mytheme_move_qq_name; ?></a><?php } ?>
            <?php if(get_option('mytheme_footer_box3_pic')){ ?> <a class="contact_footer_weixin"><?php echo $mytheme_move_wixin_name; ?></a> <?php }elseif(get_option('mytheme_wixin')){ ?> <a class="contact_footer_weixin"><?php echo $mytheme_move_wixin_name; ?></a> <?php } ?>
...
<div class="weixn_closed"></div>
 <img src="<?php if(get_option('mytheme_wixin')){echo get_option('mytheme_wixin');}elseif(get_option('mytheme_footer_box3_pic')){echo get_option('mytheme_footer_box3_pic'); }?>" />
 <div class="header_background"></div>
 </div><?php } echo stripslashes(get_option('mytheme_analytics'));?>