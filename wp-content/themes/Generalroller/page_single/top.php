 <?php  $detect = new Mobile_Detect();
	  ...
	  if($mytheme_top_pic){
	    ...
	    if($mytheme_detects=='value2'){$backgroud=$mytheme_top_pic_move; }else{

$backgroud=$mytheme_top_pic;

}}else{$backgroud=$mytheme_top_pic_move;}
...
<?php  $allsearch = new WP_Query("s=$s&showposts=-1"); $key = wp_specialchars($s, 1); $count = $allsearch->post_count; _e(''); if($word_t9!=""){echo $word_t9;}else{echo '搜索结果:';} ;echo '"'. $key.'"'; wp_reset_query(); ?>
