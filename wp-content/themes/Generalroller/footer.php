...
$word_t2=get_option('mytheme_word_t2');
 ...
 ?>
<div class="footer <?php if(!get_option("mytheme_donghuaopen")){echo 'donghuaopen'; }?>"<?php echo $footer_bs;?> >
 ...
 <div class="footer_bottom" <?php echo $footer_ds;?>>
  ...
  <div class="footer_in">
   ...
   <?php ob_start(); if(is_home()){ wp_nav_menu(array( 'theme_location'  => "link-menu2" ,'menu_class'=> 'footer_bottom_link','container' => false  ) );} ?>
   </div>
</div>
...
get_template_part( 'kefu' ); }}else{get_template_part( 'move/footer' );}  wp_footer(); ?>
