...
function mytheme_initialization_options($wp_customize){
	 ...
	 $wp_customize->add_setting('mytheme_index_blue2', array(
	    'default'        => '#f50028',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_index_blue2', array(
        'label'    => __('首页模块标题的红色', 'mytheme_index_blue2'),
        'section'  => 'mytheme_initialization_options',
        'settings' => 'mytheme_index_blue2',
    )));	
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_index_blue', array(
        'label'    => __('所有橘色，以及鼠标经过的蓝色色值调整', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
 ...
 $wp_customize->add_control('mytheme_donghuaopen', array(
        'label'      => __('动画关', 'mytheme_donghuaopen'),
        'section'    => 'mytheme_initialization_options',
