...
<?php 
 ...
 $wp_customize->add_setting('mytheme_pic_modle', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
 
    ));	
 $wp_customize->add_control('mytheme_pic_modle', array(
        'label'      => __('滚轴模式', 'mytheme_pic_modle'),
       'section'  => 'mytheme_header_options',
        'settings'   => 'mytheme_pic_modle',
		'type'    => 'select',
		 'choices'    => array(
            '' => '默认滚轴模式',
            'suojin' => '停用滚轴，横向滚动',
  ...
  $wp_customize->add_setting('mytheme_logo', array(
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'mytheme_logo', array(
	  ...
	  $wp_customize->add_setting('mytheme_nav_bac_img', array(
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
 
    ));
 
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'mytheme_nav_bac_img', array(
        'label'    => __('导航背景图片（平铺）', 'mytheme_nav_bac_img'),
        'section'  => 'mytheme_header_options',
        'settings' => 'mytheme_nav_bac_img',
     )
    )); 
 ...
 $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_title_hover', array(
        'label'    => __('鼠标经过/当前页面时标题和副标题的颜色', 'mytheme_title_hover'),
         'section'  => 'mytheme_header_options',
 ...
 $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_nav_title', array(
      'label'    => __('导航主标题颜色', 'mytheme_nav_title'),
         'section'  => 'mytheme_header_options',
 ...
 $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_nav_title2', array(
      'label'    => __('导航副标题颜色', 'mytheme_nav_title2'),
         'section'  => 'mytheme_header_options',
 ...
 $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_top_title', array(
      'label'    => __('顶部“登陆注册”等文字颜色', 'mytheme_top_title'),
         'section'  => 'mytheme_header_options',
