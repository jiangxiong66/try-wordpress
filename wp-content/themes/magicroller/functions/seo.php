...
$posttags =wp_get_post_tags($id);
			...
			if(get_post_meta($id, "关键字_p",true)){ $theme_keword= get_post_meta($id, "关键字_p",true);} 
			  elseif(get_post_meta($id, "关键字",true)){ $theme_keword= get_post_meta($id, "关键字",true);}elseif(get_option('mytheme_keywords_p')){$theme_keword= get_option('mytheme_keywords_p'); }elseif($posttags){$theme_keword=$theme_kewordss;}else{$theme_keword= get_option('mytheme_keywords');}
		}else{
