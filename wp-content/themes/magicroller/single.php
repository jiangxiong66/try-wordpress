...
<?php if(!$detect->isMobile()){  ?><div class="left_mian" id="per27" <?php if($left_right){echo 'style="float: right;"';} ?>><?php get_template_part( 'sidebar3' ); ?></div><?php }?>
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
 ...
 <div class="title_page"><h1><?php the_title();?></h1></div><div class="des_page">
  ...
  <div class="enter <?php echo get_option('mytheme_enter_p');  ?> half_5"> <?php the_content(); ?>
