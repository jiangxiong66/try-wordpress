    ...
    <?php } ?>
		 ...
		 ?>
		   ...
		   $menus_move =get_option('mytheme_menus_move') ;
		    ob_start(); 
		   if($menus_move){wp_nav_menu(array( 'menu' => $menus_move  ,'menu_class'=> 'menu','menu_id'=>'headerm','container' => false ) );}else{
		   
		    wp_nav_menu(array( 'theme_location' => 'header-menu','menu_class'=> 'menu','menu_id'=>'headerm','container' => false ) ); }?></div>
