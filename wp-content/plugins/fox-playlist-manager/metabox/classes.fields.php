...
abstract class CMB_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			<?php if ( $this->args['repeatable'] ) : ?>
				<button class="cmb-delete-field" title="Remove field"><span class="cmb-delete-field-icon">&times;</span> 删除本曲</button>
			<?php endif; ?>
			...
			<button class="button repeat-field"><?php esc_html_e( '添加音乐', 'cmb' ); ?></button>
